...
export class message_handler {
        ...
        this.menu_tree = {
            ...
            init: {
                buttons: {
                    ...
                    both: this.init.both,
                    "/back": (ctx: UContext) => {
                        this.menu_utils.handle_back(ctx, 1, "", this.init.init);
                    },
                },
                voter: {
                    buttons: {
                    ...
                    delegate: {
                        any: {
                            buttons: {
                                ...
                                "/back": (ctx: UContext) => {
                                    this.menu_utils.handle_back(ctx, 3, "", this.menu.delegate_notifications);
                                },
                            },
                            cap: {
                                buttons: {
                ...
                settings: {
                    ...
                    add: {
                        buttons: {
                            ...
                            "/back": (ctx: UContext) => {
                                this.menu_utils.handle_back(ctx, 1, "", this.menu.settings);
                            },
                        },
                    },
                    add_voter: {
                    ...
                    any: {
                        ...
                        delete: {
                            buttons: {
                                ...
                                no: (ctx: UContext) => {
                                    this.menu_utils.handle_back(
                                        ctx,
                                        1,
                                        ctx.user.states[2],
                                        this.settings.delegate_main,
                                    );
                                },
                                "/back": (ctx: UContext) => {
                                    this.menu_utils.handle_back(
                    ...
                    wallet: {
                        any: {
                            buttons: {
                                ...
                                "/back": (ctx: UContext) => {
                                    this.menu_utils.handle_back(ctx, 3, "", this.menu.voter_notifications);
                                },
                            },
                        },
                    },
                    ...
                    any: {
                        ...
                        delete: {
                            buttons: {
                                ...
                                no: (ctx: UContext) => {
                                    this.menu_utils.handle_back(ctx, 1, ctx.user.states[2], this.settings.voter_main);
                                },
                                "/back": (ctx: UContext) => {
                                    this.menu_utils.handle_back(ctx, 1, ctx.user.states[2], this.settings.voter_main);
                                },
    ...
    public handle = (ctx: UContext) => {
        ...
        if (message in buttons && message !== "text") {
            ...
            ctx.reply(
                "Invalid input. Please use your keyboard or use the /Back command if you feel like you are stuck here :)",
            );
        }
    };
}
